...
int main()
{
    ...
    scanf("%s", name); // Read the entered name and store it in the variable "name". Bei string und char ist & nicht notwendig
...
//////////////////////////////////////////////////
 ...
 char name[30]; // Declare a character array named "name" with a size of 30 characters.
    ...
    printf("enter the name: "); // Print a prompt to ask the user to enter a name.
    scanf("%29s", name); // can read just 29 characters
